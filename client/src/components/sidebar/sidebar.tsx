...
export function SidebarWithLogo() {
  ...
  return (
    <Card className="   p-4 shadow-xl shadow-blue-gray-900/5 w-full  max-w-[290px] sticky top-0 z-0 h-[100vh] rounded-none hidden lg:block overflow-x-auto">
      ...
      <Alert open={openAlert} className="mt-auto h-fit w-[250px]" onClose={() => setOpenAlert(false)}>
        <CubeTransparentIcon className="mb-4 h-12 w-12" />
        <Typography variant="h6" className="mb-1">
          Upgrade to PRO
        </Typography>
        <Typography variant="small" className="font-normal opacity-80">
          Upgrade to Efficsync  PRO and get even more components,
        </Typography>
