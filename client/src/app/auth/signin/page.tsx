...
<section className="m-8 flex ">
      ...
      <div className="w-full lg:w-3/5 flex flex-col items-center justify-center">
        <div className="text-center">
          <Typography variant="h2" className="font-bold text-2xl mb-4 text-[#CECEC5]">Welcome Back! Sign in to EfficiSync</Typography>


          <Typography variant="paragraph"  className="text-lg font-normal text-[#CECEC5]">Enter your email and password to login.</Typography>
        </div>
        <form className="mt-8 mb-2 mx-auto w-80 max-w-screen-lg lg:w-1/2">
          ...
          <Typography variant="paragraph" className="text-center text-blue-gray-500 font-medium mt-4">
            ...
            <Link href="/auth/recovery" className="text-[#ffff] ml-1 underline text-sm">Recovery?</Link>
          </Typography>
          <Typography variant="paragraph" className="text-center text-blue-gray-500 font-medium mt-4">
            New?
            <Link href="/auth/signup" className="text-[#ffff] ml-1 underline text-sm">Sign up</Link>
          </Typography>
          </div>
        </form>
